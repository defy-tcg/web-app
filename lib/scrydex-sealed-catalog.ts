...
export type SealedCatalogGame = "pokemon" | "onepiece" | "riftbound" | "gundam" | "magicthegathering";
...
function game(value: unknown): SealedCatalogGame {
  if (value !== "pokemon" && value !== "onepiece" && value !== "riftbound" && value !== "gundam" && value !== "magicthegathering") {
    throw new ScrydexError("unsupported", "Choose Pokémon, One Piece, Riftbound, Gundam, or Magic: The Gathering for sealed catalog search.");
  }
  return value;
}
