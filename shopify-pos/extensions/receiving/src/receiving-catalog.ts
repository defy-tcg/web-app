...
export const RECEIVING_CATALOG_GAMES = {pokemon: 'Pokémon', onepiece: 'One Piece', riftbound: 'Riftbound'} as const;
...
export function normalizeCatalogReference(value: unknown): CatalogReference {
  ...
  if (typeof input.game !== 'string' || !Object.hasOwn(RECEIVING_CATALOG_GAMES, input.game)) validation('Choose Pokémon, One Piece, or Riftbound for the catalog product.');
